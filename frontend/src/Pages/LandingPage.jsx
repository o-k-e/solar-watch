...
const LandingPage = () => {
    return (
        <div className="flex flex-col items-center text-center bg-[#091930] text-white px-4 pt-20 pb-10 min-h-screen">            <h1 className="text-4xl md:text-6xl font-bold mb-4">Welcome to SolarWatch</h1>
