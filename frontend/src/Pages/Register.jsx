      ...
      <div className="flex justify-center font-[sans-serif] min-h-screen pt-24 pb-10 px-4 bg-[#0d1e45] bg-no-repeat bg-cover bg-center">
        ...
        <div className="max-w-md w-full mx-auto">
          <form onSubmit={handleRegisterForm} className="bg-white bg-opacity-70 shadow-2xl rounded-lg p-6">
            <div className="mb-12">
              <h3 className="text-gray-800 text-center text-3xl font-bold">Register</h3>
            </div>
            ...
            <div className="mt-12">
              ...
              <p className="text-gray-800 text-sm text-center mt-6">
                ...
                <Link to="/login" className="text-[#394a51] font-semibold hover:underline ml-1 whitespace-nowrap">
                  Login here
                </Link>
              </p>
            </div>
